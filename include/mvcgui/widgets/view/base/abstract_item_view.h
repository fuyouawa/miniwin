...
public:
    ...
    virtual void set_model(AbstractItemModelPtr model) { model_ = model; }
    ...
    virtual AbstractItemModelPtr model() const { return model_; }
...
protected:
    ...
    std::vector<ModelIndex> selection_items_;
};
}